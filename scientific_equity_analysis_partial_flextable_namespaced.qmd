...
subtitle: "It's Ideology Masquerading as Scientific Inquiry"
...
flextable::set_flextable_defaults(
  ...
  # lextable::add_header_lines(values = "Confounding Variables Often Ignored in So-Called #   Equity' Research") |>
...
confounding_vars <- base::data.frame(
  ...
  Impact_on_Validity = base::c("High", "High", "High", "Medium", "High", "High", "High", "Medium", "High")
)
...
flextable::flextable(variance_breakdown) |>
  flextable::set_caption(caption = "Why Disaggregation Matters: Variance Within 'Red' Category") |>
  flextable::bg(i = ~ Variance > 50000, j = "Variance", bg = "#FFB6C1") |>
  flextable::bg(i = ~ Variance > 10000 & Variance <= 50000, j = "Variance", bg = "#FFFF99") |>
  flextable::bg(i = ~ Variance <= 10000, j = "Variance", bg = "#90EE90") |>
  flextable::autofit()
...
flextable::flextable(whi_summary) |>
  flextable::set_caption(caption = "HRT Effects by Age Group: Importance of Disaggregation") |>
  flextable::autofit()
...
flextable::flextable(homogeneity_results) |>
  flextable::set_caption(caption = "Homogeneity Tests: Most Demographic Comparisons Are Invalid") |>
  flextable::bg(i = ~ Valid_Comparison == "Yes", j = "Valid_Comparison", bg = "#90EE90") |>
...
flextable::flextable(variance_decomp) |>
  flextable::set_caption(caption = "Typical Variance Decomposition in Educational Data") |>
  flextable::colformat_double(j = "Variance", digits = 0) |>
  flextable::autofit()
...
flextable::flextable(within_group_demo) |>
  flextable::set_caption(caption = "Hidden Heterogeneity Within Government-Defined Categories") |>
  flextable::autofit()
```
...
flextable::flextable(sowell_demo) |>
  flextable::set_caption(caption = "The Thomas Sowell Principle: Disaggregate Until Comparable") |>
  flextable::colformat_num(j = "Mean_Salary", prefix = "$", big.mark = ",", digits = 0) |>
  flextable::autofit()
...
flextable::flextable(high_performers) |>
  flextable::set_caption(caption = "High Performers: More Similarity Across Demographics Than Within") |>
  flextable::autofit()
...
flextable::flextable(correlation_table) |>
  flextable::set_caption(caption = "What Actually Predicts Academic Success") |>
  flextable::bg(i = ~ Importance == "High", j = "Importance", bg = "#90EE90") |>
  flextable::bg(i = ~ Importance == "Medium", j = "Importance", bg = "#FFFF99") |>
...
flextable::flextable(pseudo_science_steps) |>
  flextable::set_caption(caption = "Current vs. Scientific Approaches to Educational Equity") |>
...
flextable::flextable(pharma_analogy) |>
  flextable::set_caption(caption = "Medical Research Standards vs. Educational Equity Research") |>
  flextable::autofit()
```
...
flextable::flextable(checklist_before) |>
  flextable::set_caption(caption = "Pre-Analysis Requirements") |>
  flextable::autofit()
```
...
flextable::flextable(analysis_requirements) |>
  flextable::set_caption(caption = "Analysis Requirements for Valid Group Comparisons") |>
  flextable::autofit()
```
...
flextable::flextable(red_flags) |>
  flextable::set_caption(caption = "Red Flags for Data Mining vs. Hypothesis Testing") |>
  flextable::bg(j = "Warning_Sign", bg = "#FFB6C1") |>
  flextable::bg(j = "Good_Answer", bg = "#90EE90") |>
  flextable::autofit()
```
...
flextable::flextable(violations) |>
  flextable::set_caption(caption = "Violations of Scientific Method in Current Equity Research") |>
  flextable::autofit()
```

---
title: "Executive Summary: The Pseudo-Science of Education Research"
...
1.  **Start with ideological conviction** ("equity interventions work", "boards affect student achievement")

2.  **Assume causal mechanisms exist** without theoretical or empirical justification
...
-   Cherry-picking significant results from hundreds of tests

-   Treating correlation coefficients as effect sizes

-   Using sophisticated statistical methods to obscure weak evidence
...
Had the author, who obviously worked hard on the project, limited has claims to non-causal language and not called for action by educators I would have nothing to say about this work. 

Then again, no one else would have either.
...
Educational 'equity' research exemplifies this corruption of the scientific method:

-   **Predetermined conclusion**: Systemic racism causes achievement gaps

-   **Data mining**: Finding differences in outcomes as "evidence"

-   **Causal assumption**: Differences 'prove' discrimination without testing alternatives

-   **Policy prescription**: Implementation of 'equity' interventions based on pseudo-scientific research

-   **Circular reasoning**: Failure of interventions blamed on "insufficient implementation"

Here is an example of an educational textbook designed to teach data 'scientists' how to examine data in the pseudo-scientific method, searching for evidence pointing to institutional racism. [@bovee2024data]

The young, and ernest authors deserve much praise for presenting a tour-de-force of programming instruction in the R statistical language. And, if that was as far as it went, my remarks would be limited to any perceived benefits of correlational studies to the practice of education. In fact, I would have little but praise.

However, the text is being used to educate young budding data 'scientists' who can't know why what they are learning is wrong. To see examples watch this video: [Data Science in Education Using R Book Club Chapter 9: Walkthrough 3 (2021-03-24) (dsieur01)](https://www.youtube.com/watch?v=Z5KRaOgW0sk&list=PL3x6DOfs2NGgvd741DNAnn1MEitDJQP3c&index=7)
...
This pseudo-research thrives because:
...
-   Students learn statistical procedures but not hypothesis testing logic
...
-   Questions about intervention effectiveness become taboo

-   Alternative explanations for problems can't be researched

-   Resources diverted from proven approaches to fashionable ones
...
-   **Process improvement** based on understanding variation
